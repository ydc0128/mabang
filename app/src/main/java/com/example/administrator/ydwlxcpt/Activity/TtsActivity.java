...
import com.example.administrator.ydwlxcpt.Utils.TtsSettings;
...
public class TtsActivity extends Activity implements OnClickListener{
    ...
    private void initLayout() {
        ...
        findViewById(R.id.iv_tts_back).setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tts_play:
                ...
                String text = "111111111111111111";
                // 设置参数
                setParam();
                                ...
                                new DialogInterface.OnClickListener() { // 点击单选框后的处理
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        if ("catherine".equals(voicer) || "henry".equals(voicer) || "vimary".equals(voicer)) {
                                            ...
                                            ((EditText) findViewById(R.id.tts_text)).setText(R.string.tv_content_gongsijieshao_neirong);
                                        }
                                        selectedNum = which;
                                        dialog.dismiss();
                                    }
