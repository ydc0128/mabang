    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.ll_changyongdizhi_list_jia:
                Intent intent = new Intent();
                Chongyongdizhi jia = new Chongyongdizhi();
                jia.setAW_WTel(Contast.user.getU_Tel());
                jia.setAW_Adress(Contast.user.getU_Home());
                jia.setAW_AdressWrite(Contast.user.getU_HomeWrite());
                jia.setAW_Lat(Contast.user.getU_HomeLat());
                jia.setAW_Lng(Contast.user.getU_HomeLng());
            ...
            case R.id.ll_changyongdizhi_list_gongsi:
                ...
                Chongyongdizhi gongsi = new Chongyongdizhi();
                gongsi.setAW_WTel(Contast.user.getU_Tel());
                gongsi.setAW_Adress(Contast.user.getU_Office());
                gongsi.setAW_AdressWrite(Contast.user.getU_OfficeWrite());
                gongsi.setAW_Lat(Contast.user.getU_OfficeLat());
                gongsi.setAW_Lng(Contast.user.getU_OfficeLng());
