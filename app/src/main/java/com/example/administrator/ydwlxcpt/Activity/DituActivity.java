...
public class DituActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String url_jia = Contast.Domain + "api/AdressOftenHome.ashx?";
    private String url_gongsi = Contast.Domain + "api/AdressOftenOffice.ashx?";
    private String url_changyong = Contast.Domain + "api/AdressOftenUpdate.ashx?";
    ...
    public BDLocationListener myListener = new DituActivity.MyLocationListener();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dizhi = (Chongyongdizhi) intent.getSerializableExtra("dizhi");
        //获取控件
        initViews();
...
//                Toast.makeText(MainActivity.this,result.getBusinessCircle(),Toast.LENGTH_SHORT).show();
    ...
    private void initViews() {
        ...
        buchongweizhi = (EditText) findViewById(R.id.et_ditu_cheliangweizhi);
...
//            lon = location.getLongitude();
            if (from == 1) {
                if (Contast.user.getU_HomeLat() == 0.0) {
                    lat = location.getLatitude();
                } else {
                    lat = Contast.user.getU_HomeLat();
                }
                if (Contast.user.getU_HomeLng() == 0.0) {
                    lon = location.getLongitude();
                } else {
                    lon = Contast.user.getU_HomeLng();
                }
            } else if (from == 2) {
                if (Contast.user.getU_OfficeLat() == 0.0) {
                    lat = location.getLatitude();
                } else {
                    lat = Contast.user.getU_OfficeLat();
                }
                if (Contast.user.getU_OfficeLng() == 0.0) {
                    lon = location.getLongitude();
                } else {
                    lon = Contast.user.getU_OfficeLng();
                }
            } else if (from == 3) {
                if (dizhi.getAW_Lat() == 0.0) {
                    lat = location.getLatitude();
                } else {
                    lat = dizhi.getAW_Lat();
                }
                if (dizhi.getAW_Lng() == 0.0) {
                    lon = location.getLongitude();
                } else {
                    lon = dizhi.getAW_Lng();
                }
            ...
            if (isFirstLocation) {
                ...
                new AsyncTask<Void, Void, String[]>() {
                    ...
                    protected String[] doInBackground(Void... params) {
                        if (from == 1) {
                            return new String[]{Contast.user.getU_Home(), Contast.user.getU_HomeWrite()};
                        } else if (from == 2) {
                            return new String[]{Contast.user.getU_Office(), Contast.user.getU_OfficeWrite()};
                        } else if (from == 3) {
                            return new String[]{dizhi.getAW_Adress(), dizhi.getAW_AdressWrite()};
                        }
                        return null;
                    }
...
//                        return new String[]{Contast.user.getU_Office(),Contast.user.getU_OfficeWrite()};
//                    }else if(from == 3){
//                        return new String[]{dizhi.getA_Adress(),dizhi.getA_AdressWrite()};
//                    }
//                    return null;
//                }
//
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_ditu_baocun:
                if (from == 1) {
                    ...
                    params.add("U_Home", cheliangweizhi.getText().toString());
                    params.add("U_HomeWrite", buchongweizhi.getText().toString());
                    params.add("U_HomeLng", "" + finallon);
                    params.add("U_HomeLat", "" + finallat);
                    ...
                    FormBody.Builder params = new FormBody.Builder();
                    params.add("U_Tel", Contast.user.getU_Tel());
                    params.add("U_Office", cheliangweizhi.getText().toString());
                    params.add("U_OfficeWrite", buchongweizhi.getText().toString());
                    params.add("U_OfficeLng", "" + finallon);
                    params.add("U_OfficeLat", "" + finallat);
                    params.add("keys", Contast.KEYS);
                    OkHttpClient client = new OkHttpClient();
                    Request request = new Request.Builder()
                            .url(url_gongsi)
                    ...
                    params.add("A_Adress", cheliangweizhi.getText().toString());
                    params.add("A_AdressWrite", buchongweizhi.getText().toString());
                    params.add("A_Lng", "" + finallon);
                    params.add("A_Lat", "" + finallat);
                    params.add("keys", Contast.KEYS);
                    OkHttpClient client = new OkHttpClient();
                    Request request = new Request.Builder()
                            .url(url_changyong)
